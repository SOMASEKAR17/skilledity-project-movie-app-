          ...
          >
            ...
            <div className="w-full text-[#999999]">
                <span className="text-[14px] flex justify-between font-[600]">
                    ...
                    <div className="flex gap-[2px] bg-[#141414] border-[#262626] text-[12px] rounded-[51px] border-[1px] pt-[4px] pr-[8px] pb-[4px] pl-[4px] font-[500] items-center"><img src="/eye.png" className="h-[20px] w-[20px]" alt="views" />{category.views}</div>
                </span>
            </div>
          </div>
        ))}
