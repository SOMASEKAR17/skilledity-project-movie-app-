...
const hero = ({ movie }) => {
    ...
    : null;
  return (
    <div id='home' className='h-[650px] lg:h-[1005px] bg-gradient-to-b from-black via-transparent to-black relative w-full'>
     ...
     <div className='bg-transparent w-full justify-center flex flex-col items-center z-10 absolute bottom-5 lg:bottom-40'>
        <h1 className='text-[#FFFFFF] text-[20px] font-bold'>{movie.title}</h1>
        <div className="flex flex-col lg:flex-row lg:gap-[20px] justify-center items-center">
          <button className='flex cursor-pointer  min-w-[342px] items-center justify-center gap-[4px] text-[#FFFFFF] mt-5 px-5 py-3 bg-red-500 rounded-md'><img src="/play.png" alt="play" />Play Now</button>
